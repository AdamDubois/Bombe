...
SOLUTION = ["3", "9", "4", "1"] # Ordre des cartes à mettre sur les lecteurs RFID pour résoudre l'énigme, doit correspondre à SOLUTION_READER

SOLUTION_READER = [ID_CARTE_3, ID_CARTE_9, ID_CARTE_4, ID_CARTE_1]
