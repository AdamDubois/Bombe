...
char g_uidReaders[NR_OF_READERS][32];
//#################################################################//
...
void onRequest() {
  ...
  // Ici, vous pouvez envoyer les données lues au maître
  // Par exemple, envoyer un message simple avec le caractère 0x00 à la fin du message pour indiquer la fin
  const char* message = "Donnees RFID lues"; // Exemple de message
  Wire.write(message);
